...
def sample_trajectory(
    ...
    while True:
        ...
        # (DONE)TO-DO use the most recent ob to decide what to do
        ac = policy.get_action(ob)

        # (DONE)TO-DO: take that action and get reward and next ob
        next_ob, rew, done, truncated, info = env.step(ac)

        # (DONE)TO-DO rollout can end due to done, or due to max_length
        steps += 1
